...
When examining each district individually, it becomes evident that Mission, Northern, and Tenderloin are among the districts with the highest number of incidents, while the Park district has so few that they can be easily counted. This also supports of the first plot in _figure 2_, where the specially Mission and Northern are way higher than the other districts. Furthermore, it can be seen that the crimes in the two districst also happens more frequently during the early morning and not just in the late night hours and around midnight. 
